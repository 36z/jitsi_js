...
Jitsi.Function = Jitsi.Base.mixin.call({}, /** @lends Function.prototype */ {

  /**
   * Around adds a flag to a function
   * that lets {@link Jitsi.Base.mixin} know
   ...
   */
  around: function (target) {
    target._jtAround = true;
    return target;
  },
...
Jitsi.Base.mixin.call(Function.prototype, /** @lends Function.prototype */ {
   ...
   *   // -> 17
   */
  curry: JT.Function.inferior(function () {
    if (!arguments.length) {
      return this;
    }
   ...
   *   // -> 'Hello, Mr. FancyPants'
   */
  bind: JT.Function.inferior(function (target) {
    var _method = this,
 ...
 * Array mixins
 */
Jitsi.Base.mixin.call(Array, /** @lends Array */ {
  /**
   ...
   */
  from: JT.Function.inferior(function (iterable) {
 ...
 */
Jitsi.Base.mixin.call(Array.prototype, /** @lends Array.prototype */ {
  /**
   ...
   */
  indexOf: JT.Function.inferior(function (o,s) {
    var start = s || 0;
